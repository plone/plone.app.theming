...
// var pathPrefix = "./++resource++plone.app.theming.editor/filemanager/";
// var capabilities = new Array('select', 'download', 'rename', 'delete');

// Get localized messages from file 
// through culture var or from URL
// if($.urlParam('langCode') != 0 && file_exists (pathPrefix + 'scripts/languages/'  + $.urlParam('langCode') + '.js')) culture = $.urlParam('langCode');
// var lg = [];
// $.ajax({
//   url: pathPrefix + 'scripts/languages/'  + culture + '.js',
//   async: false,
//   dataType: 'json',
