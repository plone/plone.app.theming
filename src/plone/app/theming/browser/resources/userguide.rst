...
The preceding example hinted at how to incorporate dynamic content beyond what
is rendered by a standard Plone page into the final themed page, by pulling in
content from a secondary URL using the ``href`` attribute a theme rule.
