...
Python distribution, but ``plone.app.theming`` also provides two simplified
mechanisms that only require knowledge of TAL, the syntax of Zope Page
Templates.

They both work for themes packages in resource directories, though (presently)
only for themes found on the filesystem.
